...
面向科研论文的结构化预审 Codex Skill，用于在投稿、送导师、组会讨论或合作修改前，检查论文中的研究问题、方法、变量、证据、图表、附录和引用一致性。
...
如果你希望了解底层审阅逻辑、论文类型适配方式、证据链检查原则和分级规则，可以查看两个 Skill 中的说明文件：

```text
paper-review/SKILL.md
latex-paper-review/SKILL.md
paper-review/references/review-rubric.md
latex-paper-review/references/review-rubric.md
```
